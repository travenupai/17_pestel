...
import os
from src.vidmarpestel.crew import VidmarpestelCrew
...
st.title('Análise Pestel com AI Agents - Powered byCrewAI')
...
if st.button("Executar Análise"):
    ...
    with st.spinner("Analisando... por favor, aguarde de 5 a 15 minutos, milhões de informações sendo processadas pelos 6 agentes."):
        if 'VidmarpestelCrew' in globals():
            # Executa o pipeline com a URL fornecida
            crew_instance = VidmarpestelCrew().crew()  # Cria uma instância da Crew
            ...
            if result:
                st.write("Análise concluída! Aqui estão os arquivos de saída, clique para download:")
                
                # Atualize o session_state com os resultados
                st.session_state.analise_realizada = True
                st.session_state.arquivos_md = ["economic_agent.md", "political_agent.md", "social_agent.md", "technological_agent.md", "environmental_agent.md", "legal_agent.md"]
        else:
